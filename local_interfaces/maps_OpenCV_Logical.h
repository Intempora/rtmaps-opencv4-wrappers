...
class MAPSOpenCV_Logical : public MAPSComponent
{
    // Use standard header definition macro
    MAPS_COMPONENT_STANDARD_HEADER_CODE(MAPSOpenCV_Logical)
    MAPS_COMPONENT_DYNAMIC_HEADER_CODE(MAPSOpenCV_Logical)
